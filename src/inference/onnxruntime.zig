...
pub const ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E4M3FN: c_int = 17;
pub const ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E4M3FNUZ: c_int = 18;
pub const ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E5M2: c_int = 19;
pub const ONNX_TENSOR_ELEMENT_DATA_TYPE_FLOAT8E5M2FNUZ: c_int = 20;
pub const ONNX_TENSOR_ELEMENT_DATA_TYPE_UINT4: c_int = 21;
pub const ONNX_TENSOR_ELEMENT_DATA_TYPE_INT4: c_int = 22;
...
pub const struct_OrtOptionalTypeInfo = opaque {};
pub const OrtOptionalTypeInfo = struct_OrtOptionalTypeInfo;
...
pub const struct_OrtDnnlProviderOptions = opaque {};
pub const OrtDnnlProviderOptions = struct_OrtDnnlProviderOptions;
...
pub const struct_OrtLogger = opaque {};
pub const OrtLogger = struct_OrtLogger;
pub const struct_OrtShapeInferContext = opaque {};
pub const OrtShapeInferContext = struct_OrtShapeInferContext;
pub const struct_OrtLoraAdapter = opaque {};
pub const OrtLoraAdapter = struct_OrtLoraAdapter;
pub const OrtStatusPtr = ?*OrtStatus;
pub const struct_OrtAllocator = extern struct {
    version: u32 = @import("std").mem.zeroes(u32),
    Alloc: ?*const fn ([*c]struct_OrtAllocator, usize) callconv(.c) ?*anyopaque = @import("std").mem.zeroes(?*const fn ([*c]struct_OrtAllocator, usize) callconv(.c) ?*anyopaque),
    Free: ?*const fn ([*c]struct_OrtAllocator, ?*anyopaque) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]struct_OrtAllocator, ?*anyopaque) callconv(.c) void),
    Info: ?*const fn ([*c]const struct_OrtAllocator) callconv(.c) ?*const struct_OrtMemoryInfo = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtAllocator) callconv(.c) ?*const struct_OrtMemoryInfo),
    Reserve: ?*const fn ([*c]struct_OrtAllocator, usize) callconv(.c) ?*anyopaque = @import("std").mem.zeroes(?*const fn ([*c]struct_OrtAllocator, usize) callconv(.c) ?*anyopaque),
};
...
pub const struct_OrtCUDAProviderOptions = extern struct {
    device_id: c_int = @import("std").mem.zeroes(c_int),
    cudnn_conv_algo_search: OrtCudnnConvAlgoSearch = @import("std").mem.zeroes(OrtCudnnConvAlgoSearch),
    gpu_mem_limit: usize = @import("std").mem.zeroes(usize),
    arena_extend_strategy: c_int = @import("std").mem.zeroes(c_int),
    do_copy_in_default_stream: c_int = @import("std").mem.zeroes(c_int),
    has_user_compute_stream: c_int = @import("std").mem.zeroes(c_int),
    user_compute_stream: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    default_memory_arena_cfg: ?*OrtArenaCfg = @import("std").mem.zeroes(?*OrtArenaCfg),
    tunable_op_enable: c_int = @import("std").mem.zeroes(c_int),
    tunable_op_tuning_enable: c_int = @import("std").mem.zeroes(c_int),
    tunable_op_max_tuning_duration_ms: c_int = @import("std").mem.zeroes(c_int),
};
pub const OrtCUDAProviderOptions = struct_OrtCUDAProviderOptions;
pub const struct_OrtROCMProviderOptions = extern struct {
    device_id: c_int = @import("std").mem.zeroes(c_int),
    miopen_conv_exhaustive_search: c_int = @import("std").mem.zeroes(c_int),
    gpu_mem_limit: usize = @import("std").mem.zeroes(usize),
    arena_extend_strategy: c_int = @import("std").mem.zeroes(c_int),
    do_copy_in_default_stream: c_int = @import("std").mem.zeroes(c_int),
    has_user_compute_stream: c_int = @import("std").mem.zeroes(c_int),
    user_compute_stream: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    default_memory_arena_cfg: ?*OrtArenaCfg = @import("std").mem.zeroes(?*OrtArenaCfg),
    enable_hip_graph: c_int = @import("std").mem.zeroes(c_int),
    tunable_op_enable: c_int = @import("std").mem.zeroes(c_int),
    tunable_op_tuning_enable: c_int = @import("std").mem.zeroes(c_int),
    tunable_op_max_tuning_duration_ms: c_int = @import("std").mem.zeroes(c_int),
};
...
pub const struct_OrtOpenVINOProviderOptions = extern struct {
    device_type: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    enable_npu_fast_compile: u8 = @import("std").mem.zeroes(u8),
    device_id: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    num_of_threads: usize = @import("std").mem.zeroes(usize),
    cache_dir: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    context: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    enable_opencl_throttling: u8 = @import("std").mem.zeroes(u8),
    enable_dynamic_shapes: u8 = @import("std").mem.zeroes(u8),
};
...
pub const struct_OrtTensorRTProviderOptions = extern struct {
    ...
    has_user_compute_stream: c_int = @import("std").mem.zeroes(c_int),
    user_compute_stream: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    trt_max_partition_iterations: c_int = @import("std").mem.zeroes(c_int),
    trt_min_subgraph_size: c_int = @import("std").mem.zeroes(c_int),
    trt_max_workspace_size: usize = @import("std").mem.zeroes(usize),
    trt_fp16_enable: c_int = @import("std").mem.zeroes(c_int),
    trt_int8_enable: c_int = @import("std").mem.zeroes(c_int),
    trt_int8_calibration_table_name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    trt_int8_use_native_calibration_table: c_int = @import("std").mem.zeroes(c_int),
    trt_dla_enable: c_int = @import("std").mem.zeroes(c_int),
    trt_dla_core: c_int = @import("std").mem.zeroes(c_int),
    trt_dump_subgraphs: c_int = @import("std").mem.zeroes(c_int),
    trt_engine_cache_enable: c_int = @import("std").mem.zeroes(c_int),
    trt_engine_cache_path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    trt_engine_decryption_enable: c_int = @import("std").mem.zeroes(c_int),
    trt_engine_decryption_lib_path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    trt_force_sequential_engine_build: c_int = @import("std").mem.zeroes(c_int),
};
...
pub const struct_OrtCustomHandleType = extern struct {
    __place_holder: u8 = @import("std").mem.zeroes(u8),
};
...
pub const struct_OrtMIGraphXProviderOptions = extern struct {
    device_id: c_int = @import("std").mem.zeroes(c_int),
    migraphx_fp16_enable: c_int = @import("std").mem.zeroes(c_int),
    migraphx_int8_enable: c_int = @import("std").mem.zeroes(c_int),
    migraphx_use_native_calibration_table: c_int = @import("std").mem.zeroes(c_int),
    migraphx_int8_calibration_table_name: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    migraphx_save_compiled_model: c_int = @import("std").mem.zeroes(c_int),
    migraphx_save_model_path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    migraphx_load_compiled_model: c_int = @import("std").mem.zeroes(c_int),
    migraphx_load_model_path: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    migraphx_exhaustive_tune: bool = @import("std").mem.zeroes(bool),
};
...
pub const OrtMemoryInfoDeviceType_CPU: c_int = 0;
pub const OrtMemoryInfoDeviceType_GPU: c_int = 1;
pub const OrtMemoryInfoDeviceType_FPGA: c_int = 2;
pub const enum_OrtMemoryInfoDeviceType = c_uint;
pub const OrtMemoryInfoDeviceType = enum_OrtMemoryInfoDeviceType;
pub const RunAsyncCallbackFn = ?*const fn (?*anyopaque, [*c]?*OrtValue, usize, OrtStatusPtr) callconv(.c) void;
pub const struct_OrtApi = extern struct {
    CreateStatus: ?*const fn (OrtErrorCode, [*c]const u8) callconv(.c) ?*OrtStatus = @import("std").mem.zeroes(?*const fn (OrtErrorCode, [*c]const u8) callconv(.c) ?*OrtStatus),
    GetErrorCode: ?*const fn (?*const OrtStatus) callconv(.c) OrtErrorCode = @import("std").mem.zeroes(?*const fn (?*const OrtStatus) callconv(.c) OrtErrorCode),
    GetErrorMessage: ?*const fn (?*const OrtStatus) callconv(.c) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*const OrtStatus) callconv(.c) [*c]const u8),
    CreateEnv: ?*const fn (OrtLoggingLevel, [*c]const u8, [*c]?*OrtEnv) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (OrtLoggingLevel, [*c]const u8, [*c]?*OrtEnv) callconv(.c) OrtStatusPtr),
    CreateEnvWithCustomLogger: ?*const fn (OrtLoggingFunction, ?*anyopaque, OrtLoggingLevel, [*c]const u8, [*c]?*OrtEnv) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (OrtLoggingFunction, ?*anyopaque, OrtLoggingLevel, [*c]const u8, [*c]?*OrtEnv) callconv(.c) OrtStatusPtr),
    EnableTelemetryEvents: ?*const fn (?*const OrtEnv) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtEnv) callconv(.c) OrtStatusPtr),
    DisableTelemetryEvents: ?*const fn (?*const OrtEnv) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtEnv) callconv(.c) OrtStatusPtr),
    CreateSession: ?*const fn (?*const OrtEnv, [*c]const u8, ?*const OrtSessionOptions, [*c]?*OrtSession) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtEnv, [*c]const u8, ?*const OrtSessionOptions, [*c]?*OrtSession) callconv(.c) OrtStatusPtr),
    CreateSessionFromArray: ?*const fn (?*const OrtEnv, ?*const anyopaque, usize, ?*const OrtSessionOptions, [*c]?*OrtSession) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtEnv, ?*const anyopaque, usize, ?*const OrtSessionOptions, [*c]?*OrtSession) callconv(.c) OrtStatusPtr),
    Run: ?*const fn (?*OrtSession, ?*const OrtRunOptions, [*c]const [*c]const u8, [*c]const ?*const OrtValue, usize, [*c]const [*c]const u8, usize, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSession, ?*const OrtRunOptions, [*c]const [*c]const u8, [*c]const ?*const OrtValue, usize, [*c]const [*c]const u8, usize, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    CreateSessionOptions: ?*const fn ([*c]?*OrtSessionOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]?*OrtSessionOptions) callconv(.c) OrtStatusPtr),
    SetOptimizedModelFilePath: ?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr),
    CloneSessionOptions: ?*const fn (?*const OrtSessionOptions, [*c]?*OrtSessionOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSessionOptions, [*c]?*OrtSessionOptions) callconv(.c) OrtStatusPtr),
    SetSessionExecutionMode: ?*const fn (?*OrtSessionOptions, ExecutionMode) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, ExecutionMode) callconv(.c) OrtStatusPtr),
    EnableProfiling: ?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr),
    DisableProfiling: ?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr),
    EnableMemPattern: ?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr),
    DisableMemPattern: ?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr),
    EnableCpuMemArena: ?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr),
    DisableCpuMemArena: ?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr),
    SetSessionLogId: ?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr),
    SetSessionLogVerbosityLevel: ?*const fn (?*OrtSessionOptions, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, c_int) callconv(.c) OrtStatusPtr),
    SetSessionLogSeverityLevel: ?*const fn (?*OrtSessionOptions, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, c_int) callconv(.c) OrtStatusPtr),
    SetSessionGraphOptimizationLevel: ?*const fn (?*OrtSessionOptions, GraphOptimizationLevel) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, GraphOptimizationLevel) callconv(.c) OrtStatusPtr),
    SetIntraOpNumThreads: ?*const fn (?*OrtSessionOptions, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, c_int) callconv(.c) OrtStatusPtr),
    SetInterOpNumThreads: ?*const fn (?*OrtSessionOptions, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, c_int) callconv(.c) OrtStatusPtr),
    CreateCustomOpDomain: ?*const fn ([*c]const u8, [*c]?*OrtCustomOpDomain) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]?*OrtCustomOpDomain) callconv(.c) OrtStatusPtr),
    CustomOpDomain_Add: ?*const fn (?*OrtCustomOpDomain, [*c]const OrtCustomOp) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtCustomOpDomain, [*c]const OrtCustomOp) callconv(.c) OrtStatusPtr),
    AddCustomOpDomain: ?*const fn (?*OrtSessionOptions, ?*OrtCustomOpDomain) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, ?*OrtCustomOpDomain) callconv(.c) OrtStatusPtr),
    RegisterCustomOpsLibrary: ?*const fn (?*OrtSessionOptions, [*c]const u8, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    SessionGetInputCount: ?*const fn (?*const OrtSession, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, [*c]usize) callconv(.c) OrtStatusPtr),
    SessionGetOutputCount: ?*const fn (?*const OrtSession, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, [*c]usize) callconv(.c) OrtStatusPtr),
    SessionGetOverridableInitializerCount: ?*const fn (?*const OrtSession, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, [*c]usize) callconv(.c) OrtStatusPtr),
    SessionGetInputTypeInfo: ?*const fn (?*const OrtSession, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr),
    SessionGetOutputTypeInfo: ?*const fn (?*const OrtSession, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr),
    SessionGetOverridableInitializerTypeInfo: ?*const fn (?*const OrtSession, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr),
    SessionGetInputName: ?*const fn (?*const OrtSession, usize, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, usize, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    SessionGetOutputName: ?*const fn (?*const OrtSession, usize, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, usize, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    SessionGetOverridableInitializerName: ?*const fn (?*const OrtSession, usize, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, usize, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    CreateRunOptions: ?*const fn ([*c]?*OrtRunOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]?*OrtRunOptions) callconv(.c) OrtStatusPtr),
    RunOptionsSetRunLogVerbosityLevel: ?*const fn (?*OrtRunOptions, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtRunOptions, c_int) callconv(.c) OrtStatusPtr),
    RunOptionsSetRunLogSeverityLevel: ?*const fn (?*OrtRunOptions, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtRunOptions, c_int) callconv(.c) OrtStatusPtr),
    RunOptionsSetRunTag: ?*const fn (?*OrtRunOptions, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtRunOptions, [*c]const u8) callconv(.c) OrtStatusPtr),
    RunOptionsGetRunLogVerbosityLevel: ?*const fn (?*const OrtRunOptions, [*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtRunOptions, [*c]c_int) callconv(.c) OrtStatusPtr),
    RunOptionsGetRunLogSeverityLevel: ?*const fn (?*const OrtRunOptions, [*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtRunOptions, [*c]c_int) callconv(.c) OrtStatusPtr),
    RunOptionsGetRunTag: ?*const fn (?*const OrtRunOptions, [*c][*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtRunOptions, [*c][*c]const u8) callconv(.c) OrtStatusPtr),
    RunOptionsSetTerminate: ?*const fn (?*OrtRunOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtRunOptions) callconv(.c) OrtStatusPtr),
    RunOptionsUnsetTerminate: ?*const fn (?*OrtRunOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtRunOptions) callconv(.c) OrtStatusPtr),
    CreateTensorAsOrtValue: ?*const fn ([*c]OrtAllocator, [*c]const i64, usize, ONNXTensorElementDataType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]OrtAllocator, [*c]const i64, usize, ONNXTensorElementDataType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    CreateTensorWithDataAsOrtValue: ?*const fn (?*const OrtMemoryInfo, ?*anyopaque, usize, [*c]const i64, usize, ONNXTensorElementDataType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtMemoryInfo, ?*anyopaque, usize, [*c]const i64, usize, ONNXTensorElementDataType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    IsTensor: ?*const fn (?*const OrtValue, [*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]c_int) callconv(.c) OrtStatusPtr),
    GetTensorMutableData: ?*const fn (?*OrtValue, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    FillStringTensor: ?*const fn (?*OrtValue, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    GetStringTensorDataLength: ?*const fn (?*const OrtValue, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]usize) callconv(.c) OrtStatusPtr),
    GetStringTensorContent: ?*const fn (?*const OrtValue, ?*anyopaque, usize, [*c]usize, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, ?*anyopaque, usize, [*c]usize, usize) callconv(.c) OrtStatusPtr),
    CastTypeInfoToTensorInfo: ?*const fn (?*const OrtTypeInfo, [*c]?*const OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTypeInfo, [*c]?*const OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr),
    GetOnnxTypeFromTypeInfo: ?*const fn (?*const OrtTypeInfo, [*c]enum_ONNXType) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTypeInfo, [*c]enum_ONNXType) callconv(.c) OrtStatusPtr),
    CreateTensorTypeAndShapeInfo: ?*const fn ([*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr),
    SetTensorElementType: ?*const fn (?*OrtTensorTypeAndShapeInfo, enum_ONNXTensorElementDataType) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtTensorTypeAndShapeInfo, enum_ONNXTensorElementDataType) callconv(.c) OrtStatusPtr),
    SetDimensions: ?*const fn (?*OrtTensorTypeAndShapeInfo, [*c]const i64, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtTensorTypeAndShapeInfo, [*c]const i64, usize) callconv(.c) OrtStatusPtr),
    GetTensorElementType: ?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c]enum_ONNXTensorElementDataType) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c]enum_ONNXTensorElementDataType) callconv(.c) OrtStatusPtr),
    GetDimensionsCount: ?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c]usize) callconv(.c) OrtStatusPtr),
    GetDimensions: ?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c]i64, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c]i64, usize) callconv(.c) OrtStatusPtr),
    GetSymbolicDimensions: ?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c][*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c][*c]const u8, usize) callconv(.c) OrtStatusPtr),
    GetTensorShapeElementCount: ?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTensorTypeAndShapeInfo, [*c]usize) callconv(.c) OrtStatusPtr),
    GetTensorTypeAndShape: ?*const fn (?*const OrtValue, [*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr),
    GetTypeInfo: ?*const fn (?*const OrtValue, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr),
    GetValueType: ?*const fn (?*const OrtValue, [*c]enum_ONNXType) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]enum_ONNXType) callconv(.c) OrtStatusPtr),
    CreateMemoryInfo: ?*const fn ([*c]const u8, enum_OrtAllocatorType, c_int, enum_OrtMemType, [*c]?*OrtMemoryInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const u8, enum_OrtAllocatorType, c_int, enum_OrtMemType, [*c]?*OrtMemoryInfo) callconv(.c) OrtStatusPtr),
    CreateCpuMemoryInfo: ?*const fn (enum_OrtAllocatorType, enum_OrtMemType, [*c]?*OrtMemoryInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (enum_OrtAllocatorType, enum_OrtMemType, [*c]?*OrtMemoryInfo) callconv(.c) OrtStatusPtr),
    CompareMemoryInfo: ?*const fn (?*const OrtMemoryInfo, ?*const OrtMemoryInfo, [*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtMemoryInfo, ?*const OrtMemoryInfo, [*c]c_int) callconv(.c) OrtStatusPtr),
    MemoryInfoGetName: ?*const fn (?*const OrtMemoryInfo, [*c][*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtMemoryInfo, [*c][*c]const u8) callconv(.c) OrtStatusPtr),
    MemoryInfoGetId: ?*const fn (?*const OrtMemoryInfo, [*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtMemoryInfo, [*c]c_int) callconv(.c) OrtStatusPtr),
    MemoryInfoGetMemType: ?*const fn (?*const OrtMemoryInfo, [*c]OrtMemType) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtMemoryInfo, [*c]OrtMemType) callconv(.c) OrtStatusPtr),
    MemoryInfoGetType: ?*const fn (?*const OrtMemoryInfo, [*c]OrtAllocatorType) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtMemoryInfo, [*c]OrtAllocatorType) callconv(.c) OrtStatusPtr),
    AllocatorAlloc: ?*const fn ([*c]OrtAllocator, usize, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]OrtAllocator, usize, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    AllocatorFree: ?*const fn ([*c]OrtAllocator, ?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]OrtAllocator, ?*anyopaque) callconv(.c) OrtStatusPtr),
    AllocatorGetInfo: ?*const fn ([*c]const OrtAllocator, [*c]?*const struct_OrtMemoryInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const OrtAllocator, [*c]?*const struct_OrtMemoryInfo) callconv(.c) OrtStatusPtr),
    GetAllocatorWithDefaultOptions: ?*const fn ([*c][*c]OrtAllocator) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c][*c]OrtAllocator) callconv(.c) OrtStatusPtr),
    AddFreeDimensionOverride: ?*const fn (?*OrtSessionOptions, [*c]const u8, i64) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8, i64) callconv(.c) OrtStatusPtr),
    GetValue: ?*const fn (?*const OrtValue, c_int, [*c]OrtAllocator, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, c_int, [*c]OrtAllocator, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    GetValueCount: ?*const fn (?*const OrtValue, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]usize) callconv(.c) OrtStatusPtr),
    CreateValue: ?*const fn ([*c]const ?*const OrtValue, usize, enum_ONNXType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const ?*const OrtValue, usize, enum_ONNXType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    CreateOpaqueValue: ?*const fn ([*c]const u8, [*c]const u8, ?*const anyopaque, usize, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8, ?*const anyopaque, usize, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    GetOpaqueValue: ?*const fn ([*c]const u8, [*c]const u8, ?*const OrtValue, ?*anyopaque, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8, ?*const OrtValue, ?*anyopaque, usize) callconv(.c) OrtStatusPtr),
    KernelInfoGetAttribute_float: ?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]f32) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]f32) callconv(.c) OrtStatusPtr),
    KernelInfoGetAttribute_int64: ?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]i64) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]i64) callconv(.c) OrtStatusPtr),
    KernelInfoGetAttribute_string: ?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr),
    KernelContext_GetInputCount: ?*const fn (?*const OrtKernelContext, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, [*c]usize) callconv(.c) OrtStatusPtr),
    KernelContext_GetOutputCount: ?*const fn (?*const OrtKernelContext, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, [*c]usize) callconv(.c) OrtStatusPtr),
    KernelContext_GetInput: ?*const fn (?*const OrtKernelContext, usize, [*c]?*const OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, usize, [*c]?*const OrtValue) callconv(.c) OrtStatusPtr),
    KernelContext_GetOutput: ?*const fn (?*OrtKernelContext, usize, [*c]const i64, usize, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtKernelContext, usize, [*c]const i64, usize, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    ReleaseEnv: ?*const fn (?*OrtEnv) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtEnv) callconv(.c) void),
    ReleaseStatus: ?*const fn (?*OrtStatus) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtStatus) callconv(.c) void),
    ReleaseMemoryInfo: ?*const fn (?*OrtMemoryInfo) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtMemoryInfo) callconv(.c) void),
    ReleaseSession: ?*const fn (?*OrtSession) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtSession) callconv(.c) void),
    ReleaseValue: ?*const fn (?*OrtValue) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtValue) callconv(.c) void),
    ReleaseRunOptions: ?*const fn (?*OrtRunOptions) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtRunOptions) callconv(.c) void),
    ReleaseTypeInfo: ?*const fn (?*OrtTypeInfo) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtTypeInfo) callconv(.c) void),
    ReleaseTensorTypeAndShapeInfo: ?*const fn (?*OrtTensorTypeAndShapeInfo) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtTensorTypeAndShapeInfo) callconv(.c) void),
    ReleaseSessionOptions: ?*const fn (?*OrtSessionOptions) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions) callconv(.c) void),
    ReleaseCustomOpDomain: ?*const fn (?*OrtCustomOpDomain) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtCustomOpDomain) callconv(.c) void),
    GetDenotationFromTypeInfo: ?*const fn (?*const OrtTypeInfo, [*c][*c]const u8, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTypeInfo, [*c][*c]const u8, [*c]usize) callconv(.c) OrtStatusPtr),
    CastTypeInfoToMapTypeInfo: ?*const fn (?*const OrtTypeInfo, [*c]?*const OrtMapTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTypeInfo, [*c]?*const OrtMapTypeInfo) callconv(.c) OrtStatusPtr),
    CastTypeInfoToSequenceTypeInfo: ?*const fn (?*const OrtTypeInfo, [*c]?*const OrtSequenceTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTypeInfo, [*c]?*const OrtSequenceTypeInfo) callconv(.c) OrtStatusPtr),
    GetMapKeyType: ?*const fn (?*const OrtMapTypeInfo, [*c]enum_ONNXTensorElementDataType) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtMapTypeInfo, [*c]enum_ONNXTensorElementDataType) callconv(.c) OrtStatusPtr),
    GetMapValueType: ?*const fn (?*const OrtMapTypeInfo, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtMapTypeInfo, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr),
    GetSequenceElementType: ?*const fn (?*const OrtSequenceTypeInfo, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSequenceTypeInfo, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr),
    ReleaseMapTypeInfo: ?*const fn (?*OrtMapTypeInfo) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtMapTypeInfo) callconv(.c) void),
    ReleaseSequenceTypeInfo: ?*const fn (?*OrtSequenceTypeInfo) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtSequenceTypeInfo) callconv(.c) void),
    SessionEndProfiling: ?*const fn (?*OrtSession, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSession, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    SessionGetModelMetadata: ?*const fn (?*const OrtSession, [*c]?*OrtModelMetadata) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, [*c]?*OrtModelMetadata) callconv(.c) OrtStatusPtr),
    ModelMetadataGetProducerName: ?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ModelMetadataGetGraphName: ?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ModelMetadataGetDomain: ?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ModelMetadataGetDescription: ?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ModelMetadataLookupCustomMetadataMap: ?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c]const u8, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c]const u8, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ModelMetadataGetVersion: ?*const fn (?*const OrtModelMetadata, [*c]i64) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtModelMetadata, [*c]i64) callconv(.c) OrtStatusPtr),
    ReleaseModelMetadata: ?*const fn (?*OrtModelMetadata) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtModelMetadata) callconv(.c) void),
    CreateEnvWithGlobalThreadPools: ?*const fn (OrtLoggingLevel, [*c]const u8, ?*const OrtThreadingOptions, [*c]?*OrtEnv) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (OrtLoggingLevel, [*c]const u8, ?*const OrtThreadingOptions, [*c]?*OrtEnv) callconv(.c) OrtStatusPtr),
    DisablePerSessionThreads: ?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr),
    CreateThreadingOptions: ?*const fn ([*c]?*OrtThreadingOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]?*OrtThreadingOptions) callconv(.c) OrtStatusPtr),
    ReleaseThreadingOptions: ?*const fn (?*OrtThreadingOptions) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtThreadingOptions) callconv(.c) void),
    ModelMetadataGetCustomMetadataMapKeys: ?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c][*c]u8, [*c]i64) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c][*c]u8, [*c]i64) callconv(.c) OrtStatusPtr),
    AddFreeDimensionOverrideByName: ?*const fn (?*OrtSessionOptions, [*c]const u8, i64) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8, i64) callconv(.c) OrtStatusPtr),
    GetAvailableProviders: ?*const fn ([*c][*c][*c]u8, [*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c][*c][*c]u8, [*c]c_int) callconv(.c) OrtStatusPtr),
    ReleaseAvailableProviders: ?*const fn ([*c][*c]u8, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c][*c]u8, c_int) callconv(.c) OrtStatusPtr),
    GetStringTensorElementLength: ?*const fn (?*const OrtValue, usize, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, usize, [*c]usize) callconv(.c) OrtStatusPtr),
    GetStringTensorElement: ?*const fn (?*const OrtValue, usize, usize, ?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, usize, usize, ?*anyopaque) callconv(.c) OrtStatusPtr),
    FillStringTensorElement: ?*const fn (?*OrtValue, [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    AddSessionConfigEntry: ?*const fn (?*OrtSessionOptions, [*c]const u8, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8, [*c]const u8) callconv(.c) OrtStatusPtr),
    CreateAllocator: ?*const fn (?*const OrtSession, ?*const OrtMemoryInfo, [*c][*c]OrtAllocator) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, ?*const OrtMemoryInfo, [*c][*c]OrtAllocator) callconv(.c) OrtStatusPtr),
    ReleaseAllocator: ?*const fn ([*c]OrtAllocator) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]OrtAllocator) callconv(.c) void),
    RunWithBinding: ?*const fn (?*OrtSession, ?*const OrtRunOptions, ?*const OrtIoBinding) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSession, ?*const OrtRunOptions, ?*const OrtIoBinding) callconv(.c) OrtStatusPtr),
    CreateIoBinding: ?*const fn (?*OrtSession, [*c]?*OrtIoBinding) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSession, [*c]?*OrtIoBinding) callconv(.c) OrtStatusPtr),
    ReleaseIoBinding: ?*const fn (?*OrtIoBinding) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtIoBinding) callconv(.c) void),
    BindInput: ?*const fn (?*OrtIoBinding, [*c]const u8, ?*const OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtIoBinding, [*c]const u8, ?*const OrtValue) callconv(.c) OrtStatusPtr),
    BindOutput: ?*const fn (?*OrtIoBinding, [*c]const u8, ?*const OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtIoBinding, [*c]const u8, ?*const OrtValue) callconv(.c) OrtStatusPtr),
    BindOutputToDevice: ?*const fn (?*OrtIoBinding, [*c]const u8, ?*const OrtMemoryInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtIoBinding, [*c]const u8, ?*const OrtMemoryInfo) callconv(.c) OrtStatusPtr),
    GetBoundOutputNames: ?*const fn (?*const OrtIoBinding, [*c]OrtAllocator, [*c][*c]u8, [*c][*c]usize, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtIoBinding, [*c]OrtAllocator, [*c][*c]u8, [*c][*c]usize, [*c]usize) callconv(.c) OrtStatusPtr),
    GetBoundOutputValues: ?*const fn (?*const OrtIoBinding, [*c]OrtAllocator, [*c][*c]?*OrtValue, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtIoBinding, [*c]OrtAllocator, [*c][*c]?*OrtValue, [*c]usize) callconv(.c) OrtStatusPtr),
    ClearBoundInputs: ?*const fn (?*OrtIoBinding) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtIoBinding) callconv(.c) void),
    ClearBoundOutputs: ?*const fn (?*OrtIoBinding) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtIoBinding) callconv(.c) void),
    TensorAt: ?*const fn (?*OrtValue, [*c]const i64, usize, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, [*c]const i64, usize, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    CreateAndRegisterAllocator: ?*const fn (?*OrtEnv, ?*const OrtMemoryInfo, ?*const OrtArenaCfg) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtEnv, ?*const OrtMemoryInfo, ?*const OrtArenaCfg) callconv(.c) OrtStatusPtr),
    SetLanguageProjection: ?*const fn (?*const OrtEnv, OrtLanguageProjection) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtEnv, OrtLanguageProjection) callconv(.c) OrtStatusPtr),
    SessionGetProfilingStartTimeNs: ?*const fn (?*const OrtSession, [*c]u64) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSession, [*c]u64) callconv(.c) OrtStatusPtr),
    SetGlobalIntraOpNumThreads: ?*const fn (?*OrtThreadingOptions, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtThreadingOptions, c_int) callconv(.c) OrtStatusPtr),
    SetGlobalInterOpNumThreads: ?*const fn (?*OrtThreadingOptions, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtThreadingOptions, c_int) callconv(.c) OrtStatusPtr),
    SetGlobalSpinControl: ?*const fn (?*OrtThreadingOptions, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtThreadingOptions, c_int) callconv(.c) OrtStatusPtr),
    AddInitializer: ?*const fn (?*OrtSessionOptions, [*c]const u8, ?*const OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8, ?*const OrtValue) callconv(.c) OrtStatusPtr),
    CreateEnvWithCustomLoggerAndGlobalThreadPools: ?*const fn (OrtLoggingFunction, ?*anyopaque, OrtLoggingLevel, [*c]const u8, ?*const struct_OrtThreadingOptions, [*c]?*OrtEnv) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (OrtLoggingFunction, ?*anyopaque, OrtLoggingLevel, [*c]const u8, ?*const struct_OrtThreadingOptions, [*c]?*OrtEnv) callconv(.c) OrtStatusPtr),
    SessionOptionsAppendExecutionProvider_CUDA: ?*const fn (?*OrtSessionOptions, [*c]const OrtCUDAProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const OrtCUDAProviderOptions) callconv(.c) OrtStatusPtr),
    SessionOptionsAppendExecutionProvider_ROCM: ?*const fn (?*OrtSessionOptions, [*c]const OrtROCMProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const OrtROCMProviderOptions) callconv(.c) OrtStatusPtr),
    SessionOptionsAppendExecutionProvider_OpenVINO: ?*const fn (?*OrtSessionOptions, [*c]const OrtOpenVINOProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const OrtOpenVINOProviderOptions) callconv(.c) OrtStatusPtr),
    SetGlobalDenormalAsZero: ?*const fn (?*OrtThreadingOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtThreadingOptions) callconv(.c) OrtStatusPtr),
    CreateArenaCfg: ?*const fn (usize, c_int, c_int, c_int, [*c]?*OrtArenaCfg) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (usize, c_int, c_int, c_int, [*c]?*OrtArenaCfg) callconv(.c) OrtStatusPtr),
    ReleaseArenaCfg: ?*const fn (?*OrtArenaCfg) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtArenaCfg) callconv(.c) void),
    ModelMetadataGetGraphDescription: ?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtModelMetadata, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    SessionOptionsAppendExecutionProvider_TensorRT: ?*const fn (?*OrtSessionOptions, [*c]const OrtTensorRTProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const OrtTensorRTProviderOptions) callconv(.c) OrtStatusPtr),
    SetCurrentGpuDeviceId: ?*const fn (c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (c_int) callconv(.c) OrtStatusPtr),
    GetCurrentGpuDeviceId: ?*const fn ([*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]c_int) callconv(.c) OrtStatusPtr),
    KernelInfoGetAttributeArray_float: ?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]f32, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]f32, [*c]usize) callconv(.c) OrtStatusPtr),
    KernelInfoGetAttributeArray_int64: ?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]i64, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]i64, [*c]usize) callconv(.c) OrtStatusPtr),
    CreateArenaCfgV2: ?*const fn ([*c]const [*c]const u8, [*c]const usize, usize, [*c]?*OrtArenaCfg) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const [*c]const u8, [*c]const usize, usize, [*c]?*OrtArenaCfg) callconv(.c) OrtStatusPtr),
    AddRunConfigEntry: ?*const fn (?*OrtRunOptions, [*c]const u8, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtRunOptions, [*c]const u8, [*c]const u8) callconv(.c) OrtStatusPtr),
    CreatePrepackedWeightsContainer: ?*const fn ([*c]?*OrtPrepackedWeightsContainer) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]?*OrtPrepackedWeightsContainer) callconv(.c) OrtStatusPtr),
    ReleasePrepackedWeightsContainer: ?*const fn (?*OrtPrepackedWeightsContainer) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtPrepackedWeightsContainer) callconv(.c) void),
    CreateSessionWithPrepackedWeightsContainer: ?*const fn (?*const OrtEnv, [*c]const u8, ?*const OrtSessionOptions, ?*OrtPrepackedWeightsContainer, [*c]?*OrtSession) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtEnv, [*c]const u8, ?*const OrtSessionOptions, ?*OrtPrepackedWeightsContainer, [*c]?*OrtSession) callconv(.c) OrtStatusPtr),
    CreateSessionFromArrayWithPrepackedWeightsContainer: ?*const fn (?*const OrtEnv, ?*const anyopaque, usize, ?*const OrtSessionOptions, ?*OrtPrepackedWeightsContainer, [*c]?*OrtSession) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtEnv, ?*const anyopaque, usize, ?*const OrtSessionOptions, ?*OrtPrepackedWeightsContainer, [*c]?*OrtSession) callconv(.c) OrtStatusPtr),
    SessionOptionsAppendExecutionProvider_TensorRT_V2: ?*const fn (?*OrtSessionOptions, ?*const OrtTensorRTProviderOptionsV2) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, ?*const OrtTensorRTProviderOptionsV2) callconv(.c) OrtStatusPtr),
    CreateTensorRTProviderOptions: ?*const fn ([*c]?*OrtTensorRTProviderOptionsV2) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]?*OrtTensorRTProviderOptionsV2) callconv(.c) OrtStatusPtr),
    UpdateTensorRTProviderOptions: ?*const fn (?*OrtTensorRTProviderOptionsV2, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtTensorRTProviderOptionsV2, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    GetTensorRTProviderOptionsAsString: ?*const fn (?*const OrtTensorRTProviderOptionsV2, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTensorRTProviderOptionsV2, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ReleaseTensorRTProviderOptions: ?*const fn (?*OrtTensorRTProviderOptionsV2) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtTensorRTProviderOptionsV2) callconv(.c) void),
    EnableOrtCustomOps: ?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions) callconv(.c) OrtStatusPtr),
    RegisterAllocator: ?*const fn (?*OrtEnv, [*c]OrtAllocator) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtEnv, [*c]OrtAllocator) callconv(.c) OrtStatusPtr),
    UnregisterAllocator: ?*const fn (?*OrtEnv, ?*const OrtMemoryInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtEnv, ?*const OrtMemoryInfo) callconv(.c) OrtStatusPtr),
    IsSparseTensor: ?*const fn (?*const OrtValue, [*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]c_int) callconv(.c) OrtStatusPtr),
    CreateSparseTensorAsOrtValue: ?*const fn ([*c]OrtAllocator, [*c]const i64, usize, ONNXTensorElementDataType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]OrtAllocator, [*c]const i64, usize, ONNXTensorElementDataType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    FillSparseTensorCoo: ?*const fn (?*OrtValue, ?*const OrtMemoryInfo, [*c]const i64, usize, ?*const anyopaque, [*c]const i64, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, ?*const OrtMemoryInfo, [*c]const i64, usize, ?*const anyopaque, [*c]const i64, usize) callconv(.c) OrtStatusPtr),
    FillSparseTensorCsr: ?*const fn (?*OrtValue, ?*const OrtMemoryInfo, [*c]const i64, usize, ?*const anyopaque, [*c]const i64, usize, [*c]const i64, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, ?*const OrtMemoryInfo, [*c]const i64, usize, ?*const anyopaque, [*c]const i64, usize, [*c]const i64, usize) callconv(.c) OrtStatusPtr),
    FillSparseTensorBlockSparse: ?*const fn (?*OrtValue, ?*const OrtMemoryInfo, [*c]const i64, usize, ?*const anyopaque, [*c]const i64, usize, [*c]const i32) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, ?*const OrtMemoryInfo, [*c]const i64, usize, ?*const anyopaque, [*c]const i64, usize, [*c]const i32) callconv(.c) OrtStatusPtr),
    CreateSparseTensorWithValuesAsOrtValue: ?*const fn (?*const OrtMemoryInfo, ?*anyopaque, [*c]const i64, usize, [*c]const i64, usize, ONNXTensorElementDataType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtMemoryInfo, ?*anyopaque, [*c]const i64, usize, [*c]const i64, usize, ONNXTensorElementDataType, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    UseCooIndices: ?*const fn (?*OrtValue, [*c]i64, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, [*c]i64, usize) callconv(.c) OrtStatusPtr),
    UseCsrIndices: ?*const fn (?*OrtValue, [*c]i64, usize, [*c]i64, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, [*c]i64, usize, [*c]i64, usize) callconv(.c) OrtStatusPtr),
    UseBlockSparseIndices: ?*const fn (?*OrtValue, [*c]const i64, usize, [*c]i32) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, [*c]const i64, usize, [*c]i32) callconv(.c) OrtStatusPtr),
    GetSparseTensorFormat: ?*const fn (?*const OrtValue, [*c]enum_OrtSparseFormat) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]enum_OrtSparseFormat) callconv(.c) OrtStatusPtr),
    GetSparseTensorValuesTypeAndShape: ?*const fn (?*const OrtValue, [*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr),
    GetSparseTensorValues: ?*const fn (?*const OrtValue, [*c]?*const anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]?*const anyopaque) callconv(.c) OrtStatusPtr),
    GetSparseTensorIndicesTypeShape: ?*const fn (?*const OrtValue, enum_OrtSparseIndicesFormat, [*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, enum_OrtSparseIndicesFormat, [*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr),
    GetSparseTensorIndices: ?*const fn (?*const OrtValue, enum_OrtSparseIndicesFormat, [*c]usize, [*c]?*const anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, enum_OrtSparseIndicesFormat, [*c]usize, [*c]?*const anyopaque) callconv(.c) OrtStatusPtr),
    HasValue: ?*const fn (?*const OrtValue, [*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]c_int) callconv(.c) OrtStatusPtr),
    KernelContext_GetGPUComputeStream: ?*const fn (?*const OrtKernelContext, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    GetTensorMemoryInfo: ?*const fn (?*const OrtValue, [*c]?*const OrtMemoryInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtValue, [*c]?*const OrtMemoryInfo) callconv(.c) OrtStatusPtr),
    GetExecutionProviderApi: ?*const fn ([*c]const u8, u32, [*c]?*const anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const u8, u32, [*c]?*const anyopaque) callconv(.c) OrtStatusPtr),
    SessionOptionsSetCustomCreateThreadFn: ?*const fn (?*OrtSessionOptions, OrtCustomCreateThreadFn) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, OrtCustomCreateThreadFn) callconv(.c) OrtStatusPtr),
    SessionOptionsSetCustomThreadCreationOptions: ?*const fn (?*OrtSessionOptions, ?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, ?*anyopaque) callconv(.c) OrtStatusPtr),
    SessionOptionsSetCustomJoinThreadFn: ?*const fn (?*OrtSessionOptions, OrtCustomJoinThreadFn) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, OrtCustomJoinThreadFn) callconv(.c) OrtStatusPtr),
    SetGlobalCustomCreateThreadFn: ?*const fn (?*OrtThreadingOptions, OrtCustomCreateThreadFn) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtThreadingOptions, OrtCustomCreateThreadFn) callconv(.c) OrtStatusPtr),
    SetGlobalCustomThreadCreationOptions: ?*const fn (?*OrtThreadingOptions, ?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtThreadingOptions, ?*anyopaque) callconv(.c) OrtStatusPtr),
    SetGlobalCustomJoinThreadFn: ?*const fn (?*OrtThreadingOptions, OrtCustomJoinThreadFn) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtThreadingOptions, OrtCustomJoinThreadFn) callconv(.c) OrtStatusPtr),
    SynchronizeBoundInputs: ?*const fn (?*OrtIoBinding) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtIoBinding) callconv(.c) OrtStatusPtr),
    SynchronizeBoundOutputs: ?*const fn (?*OrtIoBinding) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtIoBinding) callconv(.c) OrtStatusPtr),
    SessionOptionsAppendExecutionProvider_CUDA_V2: ?*const fn (?*OrtSessionOptions, ?*const OrtCUDAProviderOptionsV2) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, ?*const OrtCUDAProviderOptionsV2) callconv(.c) OrtStatusPtr),
    CreateCUDAProviderOptions: ?*const fn ([*c]?*OrtCUDAProviderOptionsV2) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]?*OrtCUDAProviderOptionsV2) callconv(.c) OrtStatusPtr),
    UpdateCUDAProviderOptions: ?*const fn (?*OrtCUDAProviderOptionsV2, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtCUDAProviderOptionsV2, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    GetCUDAProviderOptionsAsString: ?*const fn (?*const OrtCUDAProviderOptionsV2, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtCUDAProviderOptionsV2, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ReleaseCUDAProviderOptions: ?*const fn (?*OrtCUDAProviderOptionsV2) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtCUDAProviderOptionsV2) callconv(.c) void),
    SessionOptionsAppendExecutionProvider_MIGraphX: ?*const fn (?*OrtSessionOptions, [*c]const OrtMIGraphXProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const OrtMIGraphXProviderOptions) callconv(.c) OrtStatusPtr),
    AddExternalInitializers: ?*const fn (?*OrtSessionOptions, [*c]const [*c]const u8, [*c]const ?*const OrtValue, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const [*c]const u8, [*c]const ?*const OrtValue, usize) callconv(.c) OrtStatusPtr),
    CreateOpAttr: ?*const fn ([*c]const u8, ?*const anyopaque, c_int, OrtOpAttrType, [*c]?*OrtOpAttr) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const u8, ?*const anyopaque, c_int, OrtOpAttrType, [*c]?*OrtOpAttr) callconv(.c) OrtStatusPtr),
    ReleaseOpAttr: ?*const fn (?*OrtOpAttr) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtOpAttr) callconv(.c) void),
    CreateOp: ?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]const u8, c_int, [*c][*c]const u8, [*c]const ONNXTensorElementDataType, c_int, [*c]const ?*const OrtOpAttr, c_int, c_int, c_int, [*c]?*OrtOp) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]const u8, c_int, [*c][*c]const u8, [*c]const ONNXTensorElementDataType, c_int, [*c]const ?*const OrtOpAttr, c_int, c_int, c_int, [*c]?*OrtOp) callconv(.c) OrtStatusPtr),
    InvokeOp: ?*const fn (?*const OrtKernelContext, ?*const OrtOp, [*c]const ?*const OrtValue, c_int, [*c]const ?*OrtValue, c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, ?*const OrtOp, [*c]const ?*const OrtValue, c_int, [*c]const ?*OrtValue, c_int) callconv(.c) OrtStatusPtr),
    ReleaseOp: ?*const fn (?*OrtOp) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtOp) callconv(.c) void),
    SessionOptionsAppendExecutionProvider: ?*const fn (?*OrtSessionOptions, [*c]const u8, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    CopyKernelInfo: ?*const fn (?*const OrtKernelInfo, [*c]?*OrtKernelInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]?*OrtKernelInfo) callconv(.c) OrtStatusPtr),
    ReleaseKernelInfo: ?*const fn (?*OrtKernelInfo) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtKernelInfo) callconv(.c) void),
    GetTrainingApi: ?*const fn (u32) callconv(.c) ?*const OrtTrainingApi = @import("std").mem.zeroes(?*const fn (u32) callconv(.c) ?*const OrtTrainingApi),
    SessionOptionsAppendExecutionProvider_CANN: ?*const fn (?*OrtSessionOptions, ?*const OrtCANNProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, ?*const OrtCANNProviderOptions) callconv(.c) OrtStatusPtr),
    CreateCANNProviderOptions: ?*const fn ([*c]?*OrtCANNProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]?*OrtCANNProviderOptions) callconv(.c) OrtStatusPtr),
    UpdateCANNProviderOptions: ?*const fn (?*OrtCANNProviderOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtCANNProviderOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    GetCANNProviderOptionsAsString: ?*const fn (?*const OrtCANNProviderOptions, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtCANNProviderOptions, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ReleaseCANNProviderOptions: ?*const fn (?*OrtCANNProviderOptions) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtCANNProviderOptions) callconv(.c) void),
    MemoryInfoGetDeviceType: ?*const fn (?*const OrtMemoryInfo, [*c]OrtMemoryInfoDeviceType) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*const OrtMemoryInfo, [*c]OrtMemoryInfoDeviceType) callconv(.c) void),
    UpdateEnvWithCustomLogLevel: ?*const fn (?*OrtEnv, OrtLoggingLevel) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtEnv, OrtLoggingLevel) callconv(.c) OrtStatusPtr),
    SetGlobalIntraOpThreadAffinity: ?*const fn (?*OrtThreadingOptions, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtThreadingOptions, [*c]const u8) callconv(.c) OrtStatusPtr),
    RegisterCustomOpsLibrary_V2: ?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr),
    RegisterCustomOpsUsingFunction: ?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const u8) callconv(.c) OrtStatusPtr),
    KernelInfo_GetInputCount: ?*const fn (?*const OrtKernelInfo, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]usize) callconv(.c) OrtStatusPtr),
    KernelInfo_GetOutputCount: ?*const fn (?*const OrtKernelInfo, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]usize) callconv(.c) OrtStatusPtr),
    KernelInfo_GetInputName: ?*const fn (?*const OrtKernelInfo, usize, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, usize, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr),
    KernelInfo_GetOutputName: ?*const fn (?*const OrtKernelInfo, usize, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, usize, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr),
    KernelInfo_GetInputTypeInfo: ?*const fn (?*const OrtKernelInfo, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr),
    KernelInfo_GetOutputTypeInfo: ?*const fn (?*const OrtKernelInfo, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, usize, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr),
    KernelInfoGetAttribute_tensor: ?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]OrtAllocator, [*c]?*OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]const u8, [*c]OrtAllocator, [*c]?*OrtValue) callconv(.c) OrtStatusPtr),
    HasSessionConfigEntry: ?*const fn (?*const OrtSessionOptions, [*c]const u8, [*c]c_int) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSessionOptions, [*c]const u8, [*c]c_int) callconv(.c) OrtStatusPtr),
    GetSessionConfigEntry: ?*const fn (?*const OrtSessionOptions, [*c]const u8, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtSessionOptions, [*c]const u8, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr),
    SessionOptionsAppendExecutionProvider_Dnnl: ?*const fn (?*OrtSessionOptions, ?*const OrtDnnlProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, ?*const OrtDnnlProviderOptions) callconv(.c) OrtStatusPtr),
    CreateDnnlProviderOptions: ?*const fn ([*c]?*OrtDnnlProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]?*OrtDnnlProviderOptions) callconv(.c) OrtStatusPtr),
    UpdateDnnlProviderOptions: ?*const fn (?*OrtDnnlProviderOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtDnnlProviderOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    GetDnnlProviderOptionsAsString: ?*const fn (?*const OrtDnnlProviderOptions, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtDnnlProviderOptions, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ReleaseDnnlProviderOptions: ?*const fn (?*OrtDnnlProviderOptions) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtDnnlProviderOptions) callconv(.c) void),
    KernelInfo_GetNodeName: ?*const fn (?*const OrtKernelInfo, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]u8, [*c]usize) callconv(.c) OrtStatusPtr),
    KernelInfo_GetLogger: ?*const fn (?*const OrtKernelInfo, [*c]?*const OrtLogger) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, [*c]?*const OrtLogger) callconv(.c) OrtStatusPtr),
    KernelContext_GetLogger: ?*const fn (?*const OrtKernelContext, [*c]?*const OrtLogger) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, [*c]?*const OrtLogger) callconv(.c) OrtStatusPtr),
    Logger_LogMessage: ?*const fn (?*const OrtLogger, OrtLoggingLevel, [*c]const u8, [*c]const u8, c_int, [*c]const u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtLogger, OrtLoggingLevel, [*c]const u8, [*c]const u8, c_int, [*c]const u8) callconv(.c) OrtStatusPtr),
    Logger_GetLoggingSeverityLevel: ?*const fn (?*const OrtLogger, [*c]OrtLoggingLevel) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtLogger, [*c]OrtLoggingLevel) callconv(.c) OrtStatusPtr),
    KernelInfoGetConstantInput_tensor: ?*const fn (?*const OrtKernelInfo, usize, [*c]c_int, [*c]?*const OrtValue) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, usize, [*c]c_int, [*c]?*const OrtValue) callconv(.c) OrtStatusPtr),
    CastTypeInfoToOptionalTypeInfo: ?*const fn (?*const OrtTypeInfo, [*c]?*const OrtOptionalTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTypeInfo, [*c]?*const OrtOptionalTypeInfo) callconv(.c) OrtStatusPtr),
    GetOptionalContainedTypeInfo: ?*const fn (?*const OrtOptionalTypeInfo, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtOptionalTypeInfo, [*c]?*OrtTypeInfo) callconv(.c) OrtStatusPtr),
    GetResizedStringTensorElementBuffer: ?*const fn (?*OrtValue, usize, usize, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtValue, usize, usize, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    KernelContext_GetAllocator: ?*const fn (?*const OrtKernelContext, ?*const OrtMemoryInfo, [*c][*c]OrtAllocator) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, ?*const OrtMemoryInfo, [*c][*c]OrtAllocator) callconv(.c) OrtStatusPtr),
    GetBuildInfoString: ?*const fn () callconv(.c) [*c]const u8 = @import("std").mem.zeroes(?*const fn () callconv(.c) [*c]const u8),
    CreateROCMProviderOptions: ?*const fn ([*c][*c]OrtROCMProviderOptions) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c][*c]OrtROCMProviderOptions) callconv(.c) OrtStatusPtr),
    UpdateROCMProviderOptions: ?*const fn ([*c]OrtROCMProviderOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]OrtROCMProviderOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    GetROCMProviderOptionsAsString: ?*const fn ([*c]const OrtROCMProviderOptions, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const OrtROCMProviderOptions, [*c]OrtAllocator, [*c][*c]u8) callconv(.c) OrtStatusPtr),
    ReleaseROCMProviderOptions: ?*const fn ([*c]OrtROCMProviderOptions) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]OrtROCMProviderOptions) callconv(.c) void),
    CreateAndRegisterAllocatorV2: ?*const fn (?*OrtEnv, [*c]const u8, ?*const OrtMemoryInfo, ?*const OrtArenaCfg, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtEnv, [*c]const u8, ?*const OrtMemoryInfo, ?*const OrtArenaCfg, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    RunAsync: ?*const fn (?*OrtSession, ?*const OrtRunOptions, [*c]const [*c]const u8, [*c]const ?*const OrtValue, usize, [*c]const [*c]const u8, usize, [*c]?*OrtValue, RunAsyncCallbackFn, ?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSession, ?*const OrtRunOptions, [*c]const [*c]const u8, [*c]const ?*const OrtValue, usize, [*c]const [*c]const u8, usize, [*c]?*OrtValue, RunAsyncCallbackFn, ?*anyopaque) callconv(.c) OrtStatusPtr),
    UpdateTensorRTProviderOptionsWithValue: ?*const fn (?*OrtTensorRTProviderOptionsV2, [*c]const u8, ?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtTensorRTProviderOptionsV2, [*c]const u8, ?*anyopaque) callconv(.c) OrtStatusPtr),
    GetTensorRTProviderOptionsByName: ?*const fn (?*const OrtTensorRTProviderOptionsV2, [*c]const u8, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtTensorRTProviderOptionsV2, [*c]const u8, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    UpdateCUDAProviderOptionsWithValue: ?*const fn (?*OrtCUDAProviderOptionsV2, [*c]const u8, ?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtCUDAProviderOptionsV2, [*c]const u8, ?*anyopaque) callconv(.c) OrtStatusPtr),
    GetCUDAProviderOptionsByName: ?*const fn (?*const OrtCUDAProviderOptionsV2, [*c]const u8, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtCUDAProviderOptionsV2, [*c]const u8, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    KernelContext_GetResource: ?*const fn (?*const OrtKernelContext, c_int, c_int, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, c_int, c_int, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    SetUserLoggingFunction: ?*const fn (?*OrtSessionOptions, OrtLoggingFunction, ?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, OrtLoggingFunction, ?*anyopaque) callconv(.c) OrtStatusPtr),
    ShapeInferContext_GetInputCount: ?*const fn (?*const OrtShapeInferContext, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtShapeInferContext, [*c]usize) callconv(.c) OrtStatusPtr),
    ShapeInferContext_GetInputTypeShape: ?*const fn (?*const OrtShapeInferContext, usize, [*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtShapeInferContext, usize, [*c]?*OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr),
    ShapeInferContext_GetAttribute: ?*const fn (?*const OrtShapeInferContext, [*c]const u8, [*c]?*const OrtOpAttr) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtShapeInferContext, [*c]const u8, [*c]?*const OrtOpAttr) callconv(.c) OrtStatusPtr),
    ShapeInferContext_SetOutputTypeShape: ?*const fn (?*const OrtShapeInferContext, usize, ?*const OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtShapeInferContext, usize, ?*const OrtTensorTypeAndShapeInfo) callconv(.c) OrtStatusPtr),
    SetSymbolicDimensions: ?*const fn (?*OrtTensorTypeAndShapeInfo, [*c][*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtTensorTypeAndShapeInfo, [*c][*c]const u8, usize) callconv(.c) OrtStatusPtr),
    ReadOpAttr: ?*const fn (?*const OrtOpAttr, OrtOpAttrType, ?*anyopaque, usize, [*c]usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtOpAttr, OrtOpAttrType, ?*anyopaque, usize, [*c]usize) callconv(.c) OrtStatusPtr),
    SetDeterministicCompute: ?*const fn (?*OrtSessionOptions, bool) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, bool) callconv(.c) OrtStatusPtr),
    KernelContext_ParallelFor: ?*const fn (?*const OrtKernelContext, ?*const fn (?*anyopaque, usize) callconv(.c) void, usize, usize, ?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, ?*const fn (?*anyopaque, usize) callconv(.c) void, usize, usize, ?*anyopaque) callconv(.c) OrtStatusPtr),
    SessionOptionsAppendExecutionProvider_OpenVINO_V2: ?*const fn (?*OrtSessionOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    SessionOptionsAppendExecutionProvider_VitisAI: ?*const fn (?*OrtSessionOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
    KernelContext_GetScratchBuffer: ?*const fn (?*const OrtKernelContext, ?*const OrtMemoryInfo, usize, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelContext, ?*const OrtMemoryInfo, usize, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    KernelInfoGetAllocator: ?*const fn (?*const OrtKernelInfo, OrtMemType, [*c][*c]OrtAllocator) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const OrtKernelInfo, OrtMemType, [*c][*c]OrtAllocator) callconv(.c) OrtStatusPtr),
    AddExternalInitializersFromFilesInMemory: ?*const fn (?*OrtSessionOptions, [*c]const [*c]const u8, [*c]const [*c]u8, [*c]const usize, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSessionOptions, [*c]const [*c]const u8, [*c]const [*c]u8, [*c]const usize, usize) callconv(.c) OrtStatusPtr),
    CreateLoraAdapter: ?*const fn ([*c]const u8, [*c]OrtAllocator, [*c]?*OrtLoraAdapter) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]OrtAllocator, [*c]?*OrtLoraAdapter) callconv(.c) OrtStatusPtr),
    CreateLoraAdapterFromArray: ?*const fn (?*const anyopaque, usize, [*c]OrtAllocator, [*c]?*OrtLoraAdapter) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*const anyopaque, usize, [*c]OrtAllocator, [*c]?*OrtLoraAdapter) callconv(.c) OrtStatusPtr),
    ReleaseLoraAdapter: ?*const fn (?*OrtLoraAdapter) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*OrtLoraAdapter) callconv(.c) void),
    RunOptionsAddActiveLoraAdapter: ?*const fn (?*OrtRunOptions, ?*const OrtLoraAdapter) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtRunOptions, ?*const OrtLoraAdapter) callconv(.c) OrtStatusPtr),
    SetEpDynamicOptions: ?*const fn (?*OrtSession, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*OrtSession, [*c]const [*c]const u8, [*c]const [*c]const u8, usize) callconv(.c) OrtStatusPtr),
};
pub const OrtApi = struct_OrtApi;
pub const INPUT_OUTPUT_REQUIRED: c_int = 0;
pub const INPUT_OUTPUT_OPTIONAL: c_int = 1;
pub const INPUT_OUTPUT_VARIADIC: c_int = 2;
...
pub const struct_OrtCustomOp = extern struct {
    version: u32 = @import("std").mem.zeroes(u32),
    CreateKernel: ?*const fn ([*c]const struct_OrtCustomOp, [*c]const OrtApi, ?*const OrtKernelInfo) callconv(.c) ?*anyopaque = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp, [*c]const OrtApi, ?*const OrtKernelInfo) callconv(.c) ?*anyopaque),
    GetName: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) [*c]const u8 = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) [*c]const u8),
    GetExecutionProviderType: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) [*c]const u8 = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) [*c]const u8),
    GetInputType: ?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) ONNXTensorElementDataType = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) ONNXTensorElementDataType),
    GetInputTypeCount: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) usize = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) usize),
    GetOutputType: ?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) ONNXTensorElementDataType = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) ONNXTensorElementDataType),
    GetOutputTypeCount: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) usize = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) usize),
    KernelCompute: ?*const fn (?*anyopaque, ?*OrtKernelContext) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*OrtKernelContext) callconv(.c) void),
    KernelDestroy: ?*const fn (?*anyopaque) callconv(.c) void = @import("std").mem.zeroes(?*const fn (?*anyopaque) callconv(.c) void),
    GetInputCharacteristic: ?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) OrtCustomOpInputOutputCharacteristic = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) OrtCustomOpInputOutputCharacteristic),
    GetOutputCharacteristic: ?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) OrtCustomOpInputOutputCharacteristic = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) OrtCustomOpInputOutputCharacteristic),
    GetInputMemoryType: ?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) OrtMemType = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp, usize) callconv(.c) OrtMemType),
    GetVariadicInputMinArity: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int),
    GetVariadicInputHomogeneity: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int),
    GetVariadicOutputMinArity: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int),
    GetVariadicOutputHomogeneity: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int),
    CreateKernelV2: ?*const fn ([*c]const struct_OrtCustomOp, [*c]const OrtApi, ?*const OrtKernelInfo, [*c]?*anyopaque) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp, [*c]const OrtApi, ?*const OrtKernelInfo, [*c]?*anyopaque) callconv(.c) OrtStatusPtr),
    KernelComputeV2: ?*const fn (?*anyopaque, ?*OrtKernelContext) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn (?*anyopaque, ?*OrtKernelContext) callconv(.c) OrtStatusPtr),
    InferOutputShapeFn: ?*const fn ([*c]const struct_OrtCustomOp, ?*OrtShapeInferContext) callconv(.c) OrtStatusPtr = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp, ?*OrtShapeInferContext) callconv(.c) OrtStatusPtr),
    GetStartVersion: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int),
    GetEndVersion: ?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int = @import("std").mem.zeroes(?*const fn ([*c]const struct_OrtCustomOp) callconv(.c) c_int),
    GetMayInplace: ?*const fn ([*c][*c]c_int, [*c][*c]c_int) callconv(.c) usize = @import("std").mem.zeroes(?*const fn ([*c][*c]c_int, [*c][*c]c_int) callconv(.c) usize),
    ReleaseMayInplace: ?*const fn ([*c]c_int, [*c]c_int) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]c_int, [*c]c_int) callconv(.c) void),
    GetAliasMap: ?*const fn ([*c][*c]c_int, [*c][*c]c_int) callconv(.c) usize = @import("std").mem.zeroes(?*const fn ([*c][*c]c_int, [*c][*c]c_int) callconv(.c) usize),
    ReleaseAliasMap: ?*const fn ([*c]c_int, [*c]c_int) callconv(.c) void = @import("std").mem.zeroes(?*const fn ([*c]c_int, [*c]c_int) callconv(.c) void),
};
pub const struct_OrtApiBase = extern struct {
    GetApi: ?*const fn (u32) callconv(.c) [*c]const OrtApi = @import("std").mem.zeroes(?*const fn (u32) callconv(.c) [*c]const OrtApi),
    GetVersionString: ?*const fn () callconv(.c) [*c]const u8 = @import("std").mem.zeroes(?*const fn () callconv(.c) [*c]const u8),
};
pub const OrtApiBase = struct_OrtApiBase;
pub extern fn OrtGetApiBase() [*c]const OrtApiBase;
pub const RegisterCustomOpsFn = ?*const fn (?*OrtSessionOptions, [*c]const OrtApiBase) callconv(.c) ?*OrtStatus;
pub extern fn OrtSessionOptionsAppendExecutionProvider_CUDA(options: ?*OrtSessionOptions, device_id: c_int) OrtStatusPtr;
pub extern fn OrtSessionOptionsAppendExecutionProvider_ROCM(options: ?*OrtSessionOptions, device_id: c_int) OrtStatusPtr;
pub extern fn OrtSessionOptionsAppendExecutionProvider_MIGraphX(options: ?*OrtSessionOptions, device_id: c_int) OrtStatusPtr;
pub extern fn OrtSessionOptionsAppendExecutionProvider_Dnnl(options: ?*OrtSessionOptions, use_arena: c_int) OrtStatusPtr;
pub extern fn OrtSessionOptionsAppendExecutionProvider_Tensorrt(options: ?*OrtSessionOptions, device_id: c_int) OrtStatusPtr;
...
pub const ORT_API_VERSION = @as(c_int, 21);
pub const _In_ = "";
pub const _In_z_ = "";
pub const _In_opt_ = "";
...
pub const _In_reads_ = @compileError("unable to translate C expr: unexpected token ''");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:64:9
pub const _Inout_updates_ = @compileError("unable to translate C expr: unexpected token ''");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:65:9
pub const _Out_writes_ = @compileError("unable to translate C expr: unexpected token ''");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:66:9
pub const _Inout_updates_all_ = @compileError("unable to translate C expr: unexpected token ''");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:67:9
pub const _Out_writes_bytes_all_ = @compileError("unable to translate C expr: unexpected token ''");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:68:9
pub const _Out_writes_all_ = @compileError("unable to translate C expr: unexpected token ''");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:69:9
pub const _Success_ = @compileError("unable to translate C expr: unexpected token ''");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:70:9
pub const _Outptr_result_buffer_maybenull_ = @compileError("unable to translate C expr: unexpected token ''");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:71:9
pub const ORT_ALL_ARGS_NONNULL = @compileError("unable to translate macro: undefined identifier `nonnull`");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:72:9
pub const ORT_EXPORT = @compileError("unable to translate macro: undefined identifier `visibility`");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:92:9
pub const ORT_API_CALL = "";
pub const ORT_MUST_USE_RESULT = @compileError("unable to translate macro: undefined identifier `warn_unused_result`");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:97:9
pub const ORTCHAR_T = u8;
pub inline fn ORT_TSTR(X: anytype) @TypeOf(X) {
    _ = &X;
    return X;
}
pub inline fn ORT_TSTR_ON_MACRO(X: anytype) @TypeOf(X) {
    _ = &X;
    return X;
}
pub inline fn ORT_FILE_INTERNAL(x: anytype) @TypeOf(ORT_TSTR(x)) {
    _ = &x;
    return ORT_TSTR(x);
}
pub const ORT_FILE = @compileError("unable to translate macro: undefined identifier `__FILE__`");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:118:9
pub const NO_EXCEPTION = "";
pub const ORT_API = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:143:9
pub const ORT_API_STATUS = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:145:9
pub const ORT_API2_STATUS = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:150:9
pub const ORT_API_STATUS_IMPL = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:154:9
pub const ORT_CLASS_RELEASE = @compileError("unable to translate macro: undefined identifier `Release`");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:157:9
pub const ORT_RUNTIME_CLASS = @compileError("unable to translate macro: undefined identifier `Ort`");
// /opt/homebrew/include/onnxruntime/onnxruntime_c_api.h:271:9
